...
// Course: CS 450 - Intro to Computer Graphics
...
#define XSIDE	90.f					// length of the x side of the grid
#define X0      (-XSIDE/2.)				// where one side starts
#define NX		180						// how many points in x
#define DX		( XSIDE/(float)NX )		// change in x between the points

#define YGRID	-10.f						// y-height of the grid

#define ZSIDE	90.f					// length of the z side of the grid
#define Z0      (-ZSIDE/2.)				// where one side starts
#define NZ		180						// how many points in z
...
const char *WINDOWTITLE = "OpenGL / GLUT Sample -- Steven Bertolucci";
...
const int INIT_WINDOW_SIZE = 1100;
...
Display( )
{
	...
	float ylight = 60.0f;
	float zlight = LIGHTRADIUS * sin(2.0f * M_PI * Time);
	...
	// Use the correct texture (Sun or Moon)
	...
	// Draw the mountain
	glPushMatrix();
	glTranslatef(-15.0f, 2.5f, 5.0f);
	//glScalef(20.0f, 20.0f, 20.0f);
	glCallList(MountainDL);
	glPopMatrix();

	// Draw the cottage
	glPushMatrix();
	glTranslatef(0.0f, 0.0f, 0.0f);
	glCallList(CottageDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(30.0f, -10.0f, 40.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(34.0f, -10.0f, 30.0f);
	glCallList(TreeDL);
	glPopMatrix();
	...
	// Draw the tree
	glPushMatrix();
	glTranslatef(32.0f, -10.0f, 10.0f);
	glCallList(TreeDL);
	glPopMatrix();
	...
	// Draw the tree
	glPushMatrix();
	glTranslatef(28.0f, -10.0f, -10.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(25.0f, -10.0f, -20.0f);
	glCallList(TreeDL);
	glPopMatrix();
	...
	// Draw the tree
	glPushMatrix();
	glTranslatef(-35.0f, -10.0f, -40.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(-28.0f, -10.0f, -41.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(-25.0f, -10.0f, -38.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(-30.0f, -10.0f, -36.0f);
	glCallList(TreeDL);
	glPopMatrix();
	...
	// Draw the tree
	glPushMatrix();
	glTranslatef(-25.0f, -10.0f, -40.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(-20.0f, -10.0f, -41.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(-15.0f, -10.0f, -38.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(-10.0f, -10.0f, -36.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(-5.0f, -10.0f, -40.0f);
	glCallList(TreeDL);
	glPopMatrix();
	...
	// Draw the tree
	glPushMatrix();
	glTranslatef(5.0f, -10.0f, -41.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(10.0f, -10.0f, -38.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(15.0f, -10.0f, -36.0f);
	glCallList(TreeDL);
	glPopMatrix();
	...
	// Draw the tree
	glPushMatrix();
	glTranslatef(30.0f, -10.0f, -41.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(35.0f, -10.0f, -38.0f);
	glCallList(TreeDL);
	glPopMatrix();

	// Draw the tree
	glPushMatrix();
	glTranslatef(38.0f, -10.0f, -36.0f);
	glCallList(TreeDL);
	glPopMatrix();
	...
	DoRasterString(3.0f, -3.f, 0.f, (char*)"[Captain Bertolucci]:");
	glColor3f(1.f, 1.f, 1.f);
	DoRasterString( 2.f, -4.f, 0.f, (char *)"'HOUSTON, WE HAVE A" );
	DoRasterString(3.f, -5.f, 0.f, (char*)"PROBLEM! WE ARE ");
	DoRasterString(4.f, -6.f, 0.f, (char*)"APPROACHING A DICE");
	DoRasterString(5.f, -7.f, 0.f, (char*)"STORM!!!'");*/
	...
	glDisable( GL_LIGHT0);
	glColor3f( 1.f, 1.f, 1.f );
	DoRasterString( 5.f, 5.f, 0.f, (char *)"Final Project by Steven Bertolucci" );
	glEnable( GL_LIGHTING );
	glEnable( GL_LIGHT0 );
...
InitLists( )
{
	...
	OsuSphere(1., 200., 200.);													// use enough polygonal detail to look nice 
	glEndList();
	...
	for (int i = 0; i < NZ; i++)
	{
		...
		for (int j = 0; j < NX; j++) {
			...
			float t0 = (float)i / (NZ - 1);
			float t1 = (float)(i + 1) / (NZ - 1); 
	...
	// Create the object (Trees)
	TreeDL = glGenLists(1);
	glNewList(TreeDL, GL_COMPILE);
	glPushMatrix();
	glScalef(2.0f, 2.0f, 2.0f);				
	glColor3f(.0f, 1.0f, 0.0f);
	LoadObjFile((char*)"GenTree.obj");
	glPopMatrix();
	glEndList();

	// Create the object (Ocean)
	OceanDL = glGenLists(1);
	glNewList(OceanDL, GL_COMPILE);
	glPushMatrix();
	glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, OceanTex);
